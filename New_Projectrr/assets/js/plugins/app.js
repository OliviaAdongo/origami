...
var option_navigation_mode = "sticky",
  ...
  option_google_maps_api_key = "AIzaSyBibXe8KqGeC6orbxHN_32X2drJUN8WokWXE",
  option_google_maps_coordinates = [40.761418, -73.977622],
  ...
  option_hero_background_image_path = [{ src: "assets/images/1.jpg" }],
  ...
  option_hero_background_youtube_url =
  ...
  option_hero_background_gradient_colorArray = new Array(
    [62, 35, 255],
    [60, 255, 60],
    [255, 35, 98],
    [45, 175, 230],
  ...
  option_hero_background_sphere_rotation_speed = 0.2,
  ...
  option_hero_background_width_expansion = 0.8,
...
if (
  ...
  jQuery(document).ready(function () {
    ...
    $(".navigation-main .navigation-items").onePageNav({
      ...
      "on" == option_animate_content_on_scroll &&
      ...
      $(".default-slider-1").cubeportfolio({
        ...
        gridAdjustment: "responsive",
        mediaQueries: [{ width: 1500, cols: 1 }],
        gapHorizontal: 0,
        gapVertical: 0,
        caption: "opacity",
        displayType: "fadeIn",
      ...
      $(".default-carousel-1").cubeportfolio({
        ...
        singlePageCallback: function (o, e) {
          var a = this;
          $.ajax({ url: o, type: "GET", dataType: "html", timeout: 1e4 })
            .done(function (o) {
      ...
      $("body").on("click", ".popup .button-description", function () {
        $(".popup .button-description").hasClass("active")
      ...
      $(document).on("click", "a.cbp-lightbox", function () {
        setTimeout(function () {
          $(".cbp-popup-lightbox .cbp-popup-content").append(
            '<div id="popup-close-button-1" class="popup-close-button" data-action="close"><span class="ti-back-left" data-action="close"></span></div>'
          ),
            setTimeout(function () {
              $(".cbp-popup-lightbox-img").attr("data-action", ""),
                $(".cbp-popup-lightbox").attr("data-action", ""),
                $(".popup-close-button").addClass("active"),
                $(".cbp-popup-lightbox video").length &&
...
!(function (o) {
  (jQuery.browser = jQuery.browser || {}).mobile =
    /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|android|ipad|playbook|silk|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(
      o
    ) ||
...
$(document).ready(function () {
  ...
  $("#page-loader").after(a),
    ...
    $(".options-panel .navigation-sticky-button").click(function () {
      $(".options-panel .nvb").removeClass("active"),
        $(this).addClass("active"),
        $("html, body").animate({ scrollTop: "0" }),
        $(".navigation-main").removeClass("popup-navigation"),
        $(".navigation-main").addClass("sticky-navigation"),
        $(".navigation-main.sticky-navigation").sticky({ topSpacing: 0 });
    }),
    $(".options-panel .navigation-popup-button").click(function () {
      $(".options-panel .nvb").removeClass("active"),
        ...
        $(".navigation-main.sticky-navigation").unstick(),
        $("#sticky-wrapper > .sticky-navigation").unwrap(),
        $(".navigation-main").removeClass("sticky-navigation"),
        $(".navigation-main").addClass("popup-navigation"),
        $(document).scroll(function () {
          $(this).scrollTop() > $(window).height()
            ? $(".navigation-main.popup-navigation").addClass("show")
    ...
    $(".options-panel .gravity-remove-button").click(function () {
      $("#canvas canvas").length &&
        ...
        $(
          ".options-panel .gravity-remove-button,.options-panel .pei"
        ).remove());
    }),
    ("waves" === option_hero_background_mode ||
      "sphere" === option_hero_background_mode ||
      "mesh" === option_hero_background_mode ||
      "space" === option_hero_background_mode ||
      "abstract" === option_hero_background_mode ||
      $("#hero").hasClass("slider-revolution") ||
      $("#hero").hasClass("slider-revolution") ||
      $("#hero").hasClass("half-height")) &&
      $(".options-panel .gravity-remove-button,.options-panel .pei").remove(),
    ($("#hero").hasClass("error-404") ||
      $("#hero").hasClass("sl") ||
      $("#hero").hasClass("half-height")) &&
      $(
        ".options-panel h4:contains('Navigation Mode'),.options-panel .nvb"
      ).remove();
});
...
jQuery(document).ready(function () {
  ...
  function n() {
    "on" === option_hero_background_youtube_controls &&
      ...
      "on" === option_hero_background_youtube_mute &&
        ((option_hero_background_youtube_mute = !0),
        $(".volume-button")
          .removeClass("fa-volume-up")
          .addClass("fa-volume-off")),
      "off" === option_hero_background_youtube_mute &&
        (option_hero_background_youtube_mute = !1),
      "off" === option_hero_background_youtube_loop
        ? (option_hero_background_youtube_loop = !1)
        : (option_hero_background_youtube_loop = !0),
      $(".hero .bg-video").append(
        '<div id="bg-youtube" class="player showOn-video-bg"></div>'
      ),
      $(".hero #bg-youtube").attr(
        "data-property",
        '{videoURL:option_hero_background_youtube_url,containment:".bg-video",autoPlay:true,mute:option_hero_background_youtube_mute,startAt: option_hero_background_youtube_startPoint,stopAt: option_hero_background_youtube_endPoint,loop: option_hero_background_youtube_loop,opacity:1,stopMovieOnBlur:false,showControls:false}'
      ),
      $(".player").mb_YTPlayer(),
      $(".hero .controls").addClass("show"),
      $(".volume-button").click(function () {
        $("#bg-youtube").hasClass("isMuted")
    ...
    $("#bg-youtube").on("YTPPause", function () {
      ...
      "on" == option_hero_background_youtube_smart_pause &&
        jQuery(window).load(function () {
          var t,
            e = !1;
          $("#bg-youtube").on("YTPPlay", function () {
            ...
            option_hero_background_youtube_mute && (t = !0),
  ...
  function i() {
    $(".hero .level-2").css(
      "background",
      option_hero_background_color_custom_color
    ),
  ...
  function a() {
    function t() {
      ...
      n
        ...
        .css({
          background:
            "-moz-linear-gradient(left, " + _ + " 0%, " + m + " 100%)",
        }),
        (o += a),
        o >= 1 &&
          ((o %= 1),
          ...
          (i[2] = i[3]),
          (i[1] =
            (i[1] + Math.floor(1 + Math.random() * (e.length - 1))) % e.length),
          (i[3] =
            (i[3] + Math.floor(1 + Math.random() * (e.length - 1))) %
            e.length));
    }
  ...
  function r() {
    function t() {
      ...
      (t = document.createElement("div")),
        ...
        (a = new THREE.PerspectiveCamera(75, c / h, 1, 1e4)),
        (a.position.z = option_hero_background_sphere_distance),
        (r = new THREE.Scene()),
        (s = new THREE.CanvasRenderer()),
        s.setPixelRatio(window.devicePixelRatio),
        s.setSize(c, h),
        t.appendChild(s.domElement),
        s.setClearColor(option_hero_background_sphere_background_color);
      for (
        var i = 2 * Math.PI,
          l = new THREE.SpriteCanvasMaterial({
            color: option_hero_background_sphere_dot_color,
            program: function (t) {
              t.beginPath(), t.arc(0, 0, 0.5, 0, i, !0), t.fill();
            },
          }),
          u = 0;
        1e3 > u;
        ...
        (n = new THREE.Sprite(l)),
          (n.position.x = 2 * Math.random() - 1),
          (n.position.y = 2 * Math.random() - 1),
          (n.position.z = 2 * Math.random() - 1),
          n.position.normalize(),
          n.position.multiplyScalar(10 * Math.random() + 450),
      ...
      for (var u = 0; 300 > u; u++) {
        ...
        var g = _.clone();
        g.multiplyScalar(0.3 * Math.random() + 1), d.vertices.push(g);
        var p = new THREE.Line(
          d,
    ...
    function i() {
      g &&
        ((a.position.x += 0.05 * (l - a.position.x)),
        (a.position.y += 0.05 * (-u + 200 - a.position.y)),
        a.lookAt(r.position),
        (r.rotation.y += option_hero_background_sphere_rotation_speed / 100),
        s.render(r, a));
    }
  ...
  function s() {
    function t() {
      (a = document.createElement("div")),
        ...
        (r = new THREE.PerspectiveCamera(75, g / p, 1, 1e4)),
        (r.position.z = option_hero_background_waves_distance),
        (s = new THREE.Scene()),
        (h = new Array());
      for (
        var t = 2 * Math.PI,
          n = new THREE.SpriteCanvasMaterial({
            ...
            program: function (e) {
              e.beginPath(), e.arc(0, 0, 0.5, 0, t, !0), e.fill();
            },
          }),
          i = 0,
          f = 0;
        ...
        for (var m = 0; _ > m; m++)
          (l = h[i++] = new THREE.Sprite(n)),
            (l.position.x = f * u - (d * u) / 2),
            (l.position.z = m * u - (_ * u) / 2),
            s.add(l);
      (c = new THREE.CanvasRenderer()),
        c.setPixelRatio(window.devicePixelRatio),
        c.setSize(g, p),
        a.appendChild(c.domElement),
        c.setClearColor(option_hero_background_waves_background_color),
        document.addEventListener("mousemove", o, !1),
        window.addEventListener("resize", e, !1);
    }
    function e() {
    ...
    function i() {
      if (w) {
        (r.position.x += 0.05 * (m - r.position.x)),
          (r.position.y += 0.05 * (-v - r.position.y)),
          r.lookAt(s.position);
        for (var t = 0, e = 0; d > e; e++)
          for (var o = 0; _ > o; o++)
            (l = h[t++]),
              (l.position.y =
                50 * Math.sin(0.3 * (e + f)) + 50 * Math.sin(0.5 * (o + f))),
              (l.scale.x = l.scale.y =
                4 * (Math.sin(0.3 * (e + f)) + 1) +
                4 * (Math.sin(0.5 * (o + f)) + 1));
        c.render(s, r), (f += 0.1);
      }
    }
    $(".hero .background-content .bg-overlay").css("z-index", "2");
    var a,
      ...
      h,
      l,
      u = option_hero_background_waves_dotSpacing,
  ...
  function c() {
    function t(t) {
      (this.x = t.x),
        ...
        (this.yBase = this.y),
        (this.offset = e(0, 1e3)),
        (this.duration = e(20, 60)),
        (this.range = e(5, 5)),
        (this.dir = e(0, 1) > 0.5 ? 1 : -1),
        (this.rad = e(2, 4));
    }
    function e(t, e) {
    ...
    function n() {
      (l = document.createElement("canvas")),
        ...
        (g = 180),
        (p = 0.25 * g),
        document.getElementById("canvas").appendChild(l),
        i(),
        c();
    }
    function i() {
      (d = $(".hero .level-1").width()),
        (_ = $(".hero .level-1").height()),
        (l.width = d),
        (l.height = _),
        (b.x = d / 2),
        (b.y = _ / 2),
        ...
        (k = 0),
        a(),
        (u.strokeStyle = option_hero_background_mesh_color),
        (u.lineWidth = 2);
    }
    function a() {
      for (var o = -g / 2; d + g > o; o += g) {
        w++;
        for (var n = -g / 2; _ + g > n; n += g)
          o == -g / 2 && x++,
            S.push(new t({ x: ~~(o + e(-p, p)), y: ~~(n + e(-p, p)) }));
      }
    }
    function r() {
      y ||
        ((b.x = d / 2 + 90 * Math.cos(k / 40)),
        (b.y = _ / 2 + 90 * Math.sin(k / 40))),
    ...
    function s() {
      ...
      for (var t = 0; w > t; t++)
        for (var e = 0; x > e; e++)
          (f = S[t * x + e]),
            (m = t === w - 1 ? null : S[(t + 1) * x + e]),
            (v = e === x - 1 ? null : S[t * x + e + 1]),
            m && (u.moveTo(f.x, f.y), u.lineTo(m.x, m.y)),
            v && (u.moveTo(f.x, f.y), u.lineTo(v.x, v.y));
      u.stroke(),
        (u.fillStyle = "#000"),
        S.forEach(function (t) {
          u.save(),
      ...
      var o = u.createRadialGradient(
        b.x,
        b.y,
        0,
        b.x,
        b.y,
        option_hero_background_mesh_spotlight_size
      );
    ...
    (t.prototype.step = function () {
      (this.x =
        this.xBase +
        this.dir * Math.sin((k + this.offset) / this.duration) * this.range),
        (this.y =
          this.yBase +
          this.dir * Math.cos((k + this.offset) / this.duration) * this.range);
      var t = o(this, b);
      (this.x = this.x + 100 * Math.cos(t)),
        (this.y = this.y + 100 * Math.sin(t));
    }),
      window.addEventListener("resize", i),
      window.addEventListener("mousemove", h),
      n(),
      $(".hero .background-content #canvas canvas").css(
        "background-color",
  ...
  function h() {
    !(function (t, e, o, n) {
      ...
      !(function () {
        for (
          var t = 0, o = ["ms", "moz", "webkit", "o"], n = 0;
          n < o.length && !e.requestAnimationFrame;
          ++n
        )
          (e.requestAnimationFrame = e[o[n] + "RequestAnimationFrame"]),
            (e.cancelAnimationFrame =
              e[o[n] + "CancelAnimationFrame"] ||
              e[o[n] + "CancelRequestAnimationFrame"]);
        e.requestAnimationFrame ||
          (e.requestAnimationFrame = function (o, n) {
          ...
          resizer: function () {
            ...
            for (var a = 0; a < this.n; a++)
              (this.star[a][0] = t[a][0] * n),
                (this.star[a][1] = t[a][1] * i),
                (this.star[a][3] =
                  this.x +
                  (this.star[a][0] / this.star[a][2]) * this.star_ratio),
                (this.star[a][4] =
                  this.y +
                  (this.star[a][1] / this.star[a][2]) * this.star_ratio);
            ...
            (this.n = parseInt(
              -1 != i.indexOf("n=")
                ? i.substring(
                    i.indexOf("n=") + 2,
                    -1 !=
                      i.substring(i.indexOf("n=") + 2, i.length).indexOf("&")
                      ? i.indexOf("n=") +
                          2 +
                          i
                            .substring(i.indexOf("n=") + 2, i.length)
                            .indexOf("&")
                      : i.length
                  )
              ...
              (this.orientationSupport = e.DeviceOrientationEvent !== n),
              (this.portrait = null);
            var a = function () {
              (r.w = r.$el.width()),
                (r.h = r.$el.height()),
                ...
                r.starz[0].getContext &&
                  ((r.context = r.starz[0].getContext("2d")), (h = !0)),
          ...
          anim: function () {
            ...
            for (var t = 0; t < this.n; t++)
              (this.test = !0),
                ...
                (this.star[t][3] =
                  this.x +
                  (this.star[t][0] / this.star[t][2]) * this.star_ratio),
                (this.star[t][4] =
                  this.y +
                  (this.star[t][1] / this.star[t][2]) * this.star_ratio),
                this.star_x_save > 0 &&
          ...
          move: function () {
            function t(t) {
              if (null !== t.beta && null !== t.gamma) {
                var e = t.gamma,
                  o = t.beta;
                r.portrait || ((e = -1 * t.beta), (o = t.gamma)),
                  (r.cursor_x = r.w / 2 + 5 * e),
                  (r.cursor_y = r.h / 2 + 5 * o);
              }
            }
            function n(t) {
              (r.cursor_x = t.pageX || t.clientX + i.scrollLeft - i.clientLeft),
                (r.cursor_y = t.pageY || t.clientY + i.scrollTop - i.clientTop);
            }
  ...
  function l() {
    ...
    function o(t) {
      _ && C.removeChild(_.element),
        (_ = v),
        _.setSize(T.offsetWidth, T.offsetHeight),
        C.appendChild(_.element);
    }
    function n() {
      g = new FSS.Scene();
    }
    function i() {
      g.remove(p),
        ...
        (m = new FSS.Material(y.ambient, y.diffuse)),
        (p = new FSS.Mesh(f, m)),
        g.add(p);
      var t, e;
      for (t = f.vertices.length - 1; t >= 0; t--)
        (e = f.vertices[t]),
          (e.anchor = FSS.Vector3.clone(e.position)),
          (e.step = FSS.Vector3.create(
            Math.randomInRange(0.2, 1),
            Math.randomInRange(0.2, 1),
            Math.randomInRange(0.2, 1)
          )),
          (e.time = Math.randomInRange(0, Math.PIM2));
    }
    function a() {
      var t, e;
      for (t = g.lights.length - 1; t >= 0; t--) (e = g.lights[t]), g.remove(e);
      for (_.clear(), t = 0; t < w.count; t++)
        (e = new FSS.Light(w.ambient, w.diffuse)),
          (e.ambientHex = e.ambient.format()),
          (e.diffuseHex = e.diffuse.format()),
          g.add(e),
          (e.mass = Math.randomInRange(0.5, 1)),
          (e.velocity = FSS.Vector3.create()),
          (e.acceleration = FSS.Vector3.create()),
          (e.force = FSS.Vector3.create()),
          (e.ring = document.createElementNS(FSS.SVGNS, "circle")),
          ...
          (e.core = document.createElementNS(FSS.SVGNS, "circle")),
    ...
    function c() {
      var t,
        ...
        s = y.depth / 2;
      for (
        FSS.Vector3.copy(w.bounds, k),
          FSS.Vector3.multiplyScalar(w.bounds, w.xyScalar),
          FSS.Vector3.setZ(M, w.zOffset),
          w.autopilot &&
            ((t = Math.sin(w.step[0] * d * w.speed)),
            (e = Math.cos(w.step[1] * d * w.speed)),
            FSS.Vector3.set(M, w.bounds[0] * t, w.bounds[1] * e, w.zOffset)),
          n = g.lights.length - 1;
        n >= 0;
        n--
      ) {
        ...
        var c = Math.clamp(
            FSS.Vector3.distanceSquared(i.position, M),
            w.minDistance,
            w.maxDistance
          ),
          h = (w.gravity * i.mass) / c;
        FSS.Vector3.subtractVectors(i.force, M, i.position),
          FSS.Vector3.normalise(i.force),
          FSS.Vector3.multiplyScalar(i.force, h),
          FSS.Vector3.set(i.acceleration),
          FSS.Vector3.add(i.acceleration, i.force),
          FSS.Vector3.add(i.velocity, i.acceleration),
          FSS.Vector3.multiplyScalar(i.velocity, w.dampening),
          FSS.Vector3.limit(i.velocity, w.minLimit, w.maxLimit),
          FSS.Vector3.add(i.position, i.velocity);
      }
      for (a = f.vertices.length - 1; a >= 0; a--)
        (r = f.vertices[a]),
          (t = Math.sin(r.time + r.step[0] * d * y.speed)),
          (e = Math.cos(r.time + r.step[1] * d * y.speed)),
          (o = Math.sin(r.time + r.step[2] * d * y.speed)),
          FSS.Vector3.set(
            r.position,
            y.xRange * f.segmentWidth * t,
            y.yRange * f.sliceHeight * e,
            y.zRange * s * o - s
          ),
          FSS.Vector3.add(r.position, r.anchor);
      f.dirty = !0;
    }
    function h() {
      if ((_.render(g), w.draw)) {
        var t, e, o, n;
        for (t = g.lights.length - 1; t >= 0; t--)
          (n = g.lights[t]),
            (e = n.position[0]),
            (o = n.position[1]),
            (_.context.lineWidth = 0.5),
            _.context.beginPath(),
            _.context.arc(e, o, 10, 0, Math.PIM2),
            (_.context.strokeStyle = n.ambientHex),
            _.context.stroke(),
            _.context.beginPath(),
            _.context.arc(e, o, 4, 0, Math.PIM2),
            (_.context.fillStyle = n.diffuseHex),
            _.context.fill();
      }
    }
    function l() {
    ...
    var d,
      ...
      b = setInterval(function () {
        $(".hero .level-1 #canvas").offset().top <= 0 &&
          ...
          $(".hero .level-1 #canvas").css(
            "background",
            option_hero_background_abstract_bg_color
          ),
          clearInterval(b));
      }, 50),
      y = {
    ...
    if ((t(), canvas.getContext)) {
      ...
      setInterval(function () {
        for (var t = 1; 1e3 >= t; t++)
          P.beginPath(),
            E
              ? (P.moveTo(0, randomize(canvas.height + 10)), (E = !1))
              : (P.moveTo(randomize(canvas.width + 10), 0), (E = !0)),
            P.lineTo(
              randomize(canvas.width + 50),
              randomize(canvas.height + 50)
            ),
            P.lineTo(
              randomize(canvas.width + 50),
              randomize(canvas.height + 50)
            ),
            (P.fillStyle = getRndColor()),
            P.fill();
      }, 5e3);
    }
  }
  function u() {
    ...
    $(".hero .level-2 .bg-image").append(
      '<div class="glitch-img" style="' + t + '"></div>'
    ),
      $(".glitch-img").mgGlitch({
        destroy: !1,
        glitch: !0,
    ...
    function t(t, e) {
      function o() {
        (this.x = Math.random() * t.width),
          ...
          (this.vx = u.velocity - 0.5 * Math.random()),
          (this.vy = u.velocity - 0.5 * Math.random()),
      ...
      (o.prototype = {
            ...
            for (n = 0; i > n; n++)
              (t = u.stars[o]),
                ...
                t.x - e.x < u.distance &&
                  ...
                  t.x - e.x > -u.distance &&
                  t.y - e.y > -u.distance &&
                  t.x - u.position.x < u.radius &&
                  t.y - u.position.y < u.radius &&
                  t.x - u.position.x > -u.radius &&
                  t.y - u.position.y > -u.radius &&
                  (h.beginPath(),
                  h.moveTo(t.x, t.y),
        ...
        (this.createStars = function () {
          var e,
            n,
            i = u.length;
          for (h.clearRect(0, 0, t.width, t.height), n = 0; i > n; n++)
            u.stars.push(new o()), (e = u.stars[n]), e.create();
          e.line(), e.animate(), u.stars.splice(i, i);
        }),
        (this.setCanvas = function () {
          (t.width = u.width),
            (t.height = u.height),
            (h.fillStyle = u.star.color),
            (h.strokeStyle = u.line.color),
            (h.lineWidth = u.line.width),
            (e && e.hasOwnProperty("position")) ||
              (u.position = { x: 0.5 * t.width, y: 0.5 * t.height });
        }),
        ...
        (this.bind = function () {
          $(window).on("mousemove", function (t) {
            (u.position.x = t.pageX - c.offset().left),
              (u.position.y = t.pageY - c.offset().top);
          });
        }),
        (this.init = function () {
  ...
  if ("on" == option_hero_animate_content_on_scroll) {
    ...
    $(window).scroll(function () {
      var t = $(window).scrollTop(),
        e = 1 - (t / g) * 2.8;
      g > t &&
        ($(".front-content").css("margin-top", t),
        $(".front-content").css("opacity", e));
    });
  }
  ...
  var v = 800,
    b = 6e3;
  "slider" === option_hero_background_mode &&
    ((v = option_hero_background_slider_transitionDuration),
    (b = option_hero_background_slider_delay)),
    "kenburns" === option_hero_background_mode &&
      ((v = option_hero_background_kenburns_transitionDuration),
      (b = option_hero_background_kenburns_delay)),
    $("#cycle").cycle({
      fx: "scrollVert",
      timeout: b,
      delay: 0,
...
$(document).ready(function () {
  ...
  function e() {
    ...
    $(".slider-process .cbp-wrapper").mousedown(function () {
      ...
      $(document).mouseup(function () {
        e &&
          setTimeout(function () {
            $(".slider-process .cbp-wrapper .process-info-box").addClass(
              "active"
            ),
              (e = !1);
          }, 500);
  ...
  $(".work-grid").cubeportfolio({
    ...
    plugins: { loadMore: { element: "#work-loadmore", action: "click" } },
    caption: "revealTop",
    displayType: "default",
    displayTypeSpeed: 70,
    lightboxDelegate: ".cbp-lightbox",
    ...
    singlePageCallback: function (e, t) {
      var a = this;
      $.ajax({ url: e, type: "GET", dataType: "html", timeout: 1e4 })
        .done(function (e) {
    ...
    $("#contact-form").submit(function (e) {
      e.preventDefault();
      for (var t = $(this).serializeArray(), a = t.length, s = 0; a > s; s++)
        "true" ==
        $("#contact-form input[name='" + t[s].name + "']").attr(
          "data-require-filling"
        )
          ? t.push({ name: t[s].name + "_required", value: !0 })
          : t.push({ name: t[s].name + "_required", value: !1 });
      $.ajax({
        type: "POST",
          ...
          $("#contact-form .form-group").removeClass("error"),
            ...
            "" !== e.succesMessage &&
              ...
              $("#contact-form button span")
                .removeClass("ti-arrow-right")
                .addClass("ti-check"),
              $("#contact-form input").attr("placeholder", ""),
              $("#contact-form-message").attr("placeholder", e.succesMessage),
    ...
    $(window).on("resize", function () {
      $("#contact .map-wrapper").css(
        "height",
        0.8 * $("#contact .map-wrapper").width()
      );
    }),
  ...
  "" != option_google_maps_api_key &&
    "AIzaSyBibXe8KqGeC6orbxHN_32X2drJUN8WokWXE" != option_google_maps_api_key &&
    (t = t + "?key=" + option_google_maps_api_key),
    loadScript(t, function () {
      function e() {
        ...
        var i = {
            ...
            styles: [
              ...
              },
              {
                featureType: "water",
                elementType: "All",
                stylers: [{ lightness: -70 }, { saturation: -84 }],
              },
              {
                featureType: "landscape",
                elementType: "All",
              ...
              },
              {
                ...
                elementType: "All",
                stylers: [{ lightness: -78 }, { gamma: 2.14 }],
              },
              {
              ...
              },
              {
                featureType: "All",
                elementType: "labels.text.stroke",
                stylers: [{ gamma: 0.32 }, { visibility: "off" }],
              },
              {
                featureType: "All",
              ...
              { featureType: "road.local", stylers: [{ gamma: 0.9 }] },
              {
                elementType: "labels.text.fill",
                stylers: [{ lightness: 16 }, { gamma: 1 }],
              },
            ],
          },
        ...
        $('a[data-toggle="tab"]').on("shown.bs.tab", function () {
          ...
          c.addListener("click", function () {
            $(".tab-content .map-wrapper .button-description").addClass(
              "active"
            ),
      ...
      if (0 != $("#map").length) {
        var t = new google.maps.LatLng(
            option_google_maps_coordinates[0],
            option_google_maps_coordinates[1]
          ),
          a = 14,
          s = $(
    ...
    $("body").on(
      "click",
      ".tab-content .map-wrapper .button-description",
      function () {
        $(".tab-content .map-wrapper .button-description").hasClass("active")
          ? ($(".tab-content .map-wrapper .container-info").removeClass(
              "active"
            ),
            $(".tab-content .map-wrapper .button-description").removeClass(
              "active"
            ))
          : ($(".tab-content .map-wrapper .button-description").addClass(
              "active"
